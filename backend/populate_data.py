...
for suc_data in sucursales:
    ...
    if created:
        print(f'[OK] Sucursal "{suc.nombre}" creada')
    else:
        print(f'[OK] Sucursal "{suc.nombre}" ya existe')
...
for cargo_data in cargos:
    ...
    if created:
        print(f'[OK] Cargo "{cargo.nombre}" creado')
    else:
        print(f'[OK] Cargo "{cargo.nombre}" ya existe')

print('[OK] Datos iniciales poblados exitosamente')